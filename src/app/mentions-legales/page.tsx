...
export const metadata: Metadata = {
  ...
  description:
    "Mentions légales de THERMO PURE, spécialiste du nettoyage de façades et toitures à la vapeur basse pression à Niort (79). SIRET: 991 013 038 00013",
  alternates: {
  ...
  openGraph: {
    type: "website",
    locale: "fr_FR",
    url: "https://thermo-pure.com/mentions-legales",
    title: "Mentions Légales - THERMO PURE",
    description:
      "Mentions légales de THERMO PURE, spécialiste du nettoyage de façades et toitures à la vapeur basse pression à Niort (79).",
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                item: "https://thermo-pure.com/mentions-legales",
              },
            ],
          }),
        }}
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            ...
            <section>
              ...
              <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
                <p className="mb-2">
                  <strong>Raison sociale :</strong> THERMO PURE
                </p>
                <p className="mb-2">
                  <strong>Forme juridique :</strong> Entreprise Individuelle
                </p>
                <p className="mb-2">
                  <strong>SIRET :</strong> 991 013 038 00013
                </p>
                <p className="mb-2">
                  <strong>Siège social :</strong> 60 rue François Ier, 75008
                  Paris, France
                </p>
                <p className="mb-2">
                ...
                <p className="mb-2">
                  ...
                  <a
                    ...
                    className="text-sky-600 hover:text-sky-700"
                  >
                    contact@thermo-pure.com
                  </a>
                </p>
                <p className="mb-2">
                  <strong>Directeur de la publication :</strong> Gérant de
                  THERMO PURE
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                logo, charte graphique, etc.) est la propriété exclusive de
                THERMO PURE, sauf mention contraire.
              </p>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                THERMO PURE s&apos;efforce d&apos;assurer l&apos;exactitude et
                la mise à jour des informations diffusées sur ce site.
                Toutefois, THERMO PURE ne peut garantir l&apos;exactitude, la
                précision ou l&apos;exhaustivité des informations mises à
                disposition sur ce site.
              </p>
              <p className="text-gray-700 leading-relaxed mt-4">
                THERMO PURE ne pourra être tenue responsable des dommages
                directs ou indirects qui pourraient résulter de l&apos;accès au
                site ou de l&apos;utilisation du site et de ses informations.
              </p>
            </section>
