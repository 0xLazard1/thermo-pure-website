                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <div className="flex space-x-4">
                            ...
                            <Link href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-300 transition-all duration-300 hover:scale-110 transform">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <Link href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-300 transition-all duration-300 hover:scale-110 transform">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            <li>
                                <Link href="#presentation" className="text-emerald-100 hover:text-emerald-300 transition-colors">
                                    Présentation
                                </Link>
                            </li>
                            <li>
                                <Link href="#examples" className="text-emerald-100 hover:text-emerald-300 transition-colors">
                                    Nos réalisations
                                </Link>
                            </li>
                            <li>
                                <Link href="#about" className="text-emerald-100 hover:text-emerald-300 transition-colors">
                                    Qui sommes-nous
                                </Link>
                            </li>
                            <li>
                                <Link href="#contact" className="text-emerald-100 hover:text-emerald-300 transition-colors">
                                    Contact
                                </Link>
                            </li>
                        </ul>
